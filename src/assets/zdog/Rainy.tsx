...
const Rainy = () => {
  ...
  useEffect(() => {
    ...
    // colors
    const midnight = "#4169E1";
    const eggplant = "#525";
    const magenta = "#191970";
    const amber = "#4169E1";
    const gold = "#000080";
    const white = "#acaccF";
    const rain = "#00FFFF";
    ...
    const particle = new Zdog.Shape({
      addTo: illo,
      translate: { x: -75, y: -20, z: layerSpace * -0.25 },
      path: [ // triangle
        { x: 0, y: -1 },
        { x: 1, y: 2 },
        { x: -1, y: 2 },
    ...
    particle.copy({
      translate: { x: 64, y: -30, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: 50, y: -14, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: 32, y: -10, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: 64, y: -10, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: 80, y: -10, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: 80, y: -30, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: 82, y: -14, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: 89, y: -20, z: layerSpace * 0.5 },
    });
    particle.copy({
      translate: { x: -70, y: 2, z: layerSpace * 0.75 },
    });
    particle.copy({
      translate: { x: -65, y: 12, z: layerSpace * 0.75 },
    });
    particle.copy({
      translate: { x: -57, y: -24, z: layerSpace * 0.75 },
    });
    particle.copy({
      translate: { x: -50, y: 2, z: layerSpace * 0.75 },
    });
    particle.copy({
      translate: { x: -65, y: -22, z: layerSpace * 0.75 },
    });
    particle.copy({
      translate: { x: -70, y: 2, z: layerSpace * 0.75 },
    });
    ...
    particle.copy({
      translate: { x: 20, y: 44, z: layerSpace * 1.5 },
    });
